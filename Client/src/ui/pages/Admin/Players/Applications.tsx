                                                ...
                                                {item.status === "Pending" ? (
                                                    <>
                                                        ...
                                                        <span className="cursor-pointer">
                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                                 ...
                                                                 onClick={() => confirmPlayer(item.player.id!, false, false)}>
                                                                <path d="m15 9-6 6"/>
                                                                <path
                                                        ...
                                                        <span className="cursor-pointer">
                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                                 ...
                                                                 onClick={() => confirmPlayer(item.player.id!, true, false)}>
                                                    ...
                                                    <>
                                                        {item.status === "Confirmed" ? (
                                                            // GREEN CHECK
                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                                 width="24" height="24" fill="none" stroke="green"
                                                            ...
                                                            // RED X
                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                                 width="24" height="24" fill="none" stroke="red"
                                                                 strokeWidth="2" strokeLinecap="round"
                                                                 strokeLinejoin="round"
