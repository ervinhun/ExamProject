...
import { GameInstanceDto, mapGameStatus } from "@core/types/game";
            ...
            <div className="space-y-8">
                ...
                <div className="flex items-center gap-4 pb-4 border-b-2 border-primary">
                    <div className="flex-1">
                        ...
                        <p className="text-base text-base-content/70 mt-1 ml-3">Browse and play available lottery games</p>
                    </div>
                </div>
                ...
                <div className="flex flex-wrap justify-center gap-9">
                    {activeGames.length === 0 ? (
                        ...
                        activeGames.map((game) => {
                            ...
                            return (
                                <div key={game.id} className="card bg-base-200 border border-base-300 rounded-lg shadow-lg hover:shadow-xl transition-shadow overflow-hidden w-120">
                                    {/* Image */}
                                    ...
                                    <div className="p-6 text-center">
                                        {/* Badge */}
                                        <span className={`inline-flex items-center ${getGameTypeColor(game.template?.gameType || "")} text-xs font-medium px-2 py-1 rounded-sm gap-1 mb-3`}>
                                        ...
                                        <div className="space-y-2 text-sm text-left">
                                            ...
                                            <div className="flex justify-between">
                                                ...
                                                <span className="font-medium">1-{game.template?.poolOfNumbers || "N/A"}</span>
                                            </div>
                                            <div className="flex justify-between">
                                        ...
                                        >
                                            Play Now
                                            <svg className="w-4 h-4 ms-1.5 -me-0.5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div className="card bg-base-200 shadow-lg">
                        <div className="card-body">
                            ...
                            <p className="text-sm text-base-content/70">
                                Select your numbers, purchase tickets, and wait for the draw. Match the winning numbers to claim prizes!
                            </p>
                        </div>
                    </div>
