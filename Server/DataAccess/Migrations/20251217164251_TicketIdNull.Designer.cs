...
namespace DataAccess.Migrations
{
    ...
    [Migration("20251217164251_TicketIdNull")]
    partial class TicketIdNull
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DataAccess.Entities.Game.PickedNumber", b =>
                {
                    ...
                    b.Property<Guid?>("TicketSubscriptionId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TicketSubscriptionId");

                    b.ToTable("PickedNumbers");
                });

            modelBuilder.Entity("DataAccess.Entities.Game.TicketSubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DataAccess.Entities.Game.PickedNumber", b =>
                {
                    ...
                    b.HasOne("DataAccess.Entities.Game.TicketSubscription", null)
                        .WithMany("PickedNumbers")
                        .HasForeignKey("TicketSubscriptionId")
                        .OnDelete(DeleteBehavior.Restrict);
